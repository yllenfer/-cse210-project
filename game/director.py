...
class Director(arcade.Window):
    ...
    def on_update(self, delta_time):
        if not self.game_over:
            ...
            # Prevent game from going infinite when reaching level 3
    ...
    #         # TODO: Display score once player has lost or moved to the final level score needs to be recalculated
    #         final_score = f"Final Score:{score}"
    #         arcade.draw_text(final_score, SCREEN_WIDTH / 2, SCREEN_HEIGHT - 100, arcade.color.WHITE, 15,
    #                          anchor_x="center")
